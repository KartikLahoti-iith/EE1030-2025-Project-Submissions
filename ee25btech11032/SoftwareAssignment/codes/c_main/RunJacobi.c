...
#include "../c_libs/oneSideJacobi.h"
...
int main(void)
{
    ...
    unsigned char *img_h = stbi_load("../../figs/einstein.jpg", &width , &column , &channels , 0 );
    ...
    stbi_write_jpg("../../figs/OneSvd_e_k5.jpg",width,column,grey_ch,img_comp,30);
    double val;
